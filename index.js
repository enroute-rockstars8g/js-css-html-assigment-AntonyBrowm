...
function factorial() {
  ...
  const containerFacto = document.getElementById("factoContainer");
  if(!containerFacto.innerHTML==""){
    containerFacto.innerHTML="";
  }
  let resultado = 1;    
  for (i = 1; i <= factoNumber; i++) {  
    ...
    resultado *= i ; 
    const praragraph = document.createElement("p");
    praragraph.innerHTML = ""+(resultado)+"";
    containerFacto.appendChild(praragraph);
  } 
  }